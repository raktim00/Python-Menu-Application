...
def web_server_on_docker():
	...
	os.system("docker run -dit -p 80:80 --name {} centos".format(cont_name))
	os.system("docker exec -it {} yum install net-tools -y".format(cont_name))
	os.system("docker exec -it {} yum install httpd -y".format(cont_name))
	os.system("docker cp hi.html {}:/var/www/html".format(cont_name))
	os.system("docker exec -it {} /usr/sbin/httpd".format(cont_name))
	os.system("docker exec -it {} netstat -tnlp".format(cont_name))
	os.system("docker exec -it {} ifconfig".format(cont_name))
	os.system("tput setaf 2")
...
def docker_python():
	cont_name2=input("ENTER THE CONTAINER NAME YOU WANT TO GIVE : ")
	os.system("docker run -dit --name {} --network host centos:latest".format(cont_name2))
	os.system("docker exec -it {} yum install python36 -y".format(cont_name2))
	os.system("echo 'print(\"Hello! this is python....running\")' > test.py")
	os.system("docker cp test.py {}:/".format(cont_name2))
	os.system("tput setaf 2")
	os.system("docker exec -it {} python3 test.py".format(cont_name2))
	input("ENTER TO CONTINUE...")
	os.system("tput setaf 7")
